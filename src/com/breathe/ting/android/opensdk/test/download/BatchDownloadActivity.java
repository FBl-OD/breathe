...
public class BatchDownloadActivity extends Activity implements IXmDownloadTrackCallBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkNumButton.setText("add all");
        checkNumButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if("select all".equals(checkNumButton.getText())) {
    ...
    private void notif() {
        ...
        if(checkTrackMap.size() == noAddNum) {
            checkNumButton.setText("select none");
        } else {
            checkNumButton.setText("select all");
        }
    }
